...
#SBATCH -J i3d
#SBATCH -o /net/acadia9a/data/jchoi/data/nec_drone/2018/log/Kinetics-7-val-train-part2of2-i3d-feat_extraction_20200309.log
...
# anno_file=/net/acadia9a/data/jchoi/data/kinetics/anno/kinetics-7-val.csv
...
end_class=-1 # -1: process all the categories
class_file=/net/acadia9a/data/jchoi/data/kinetics/anno/K7-ND7-classes.txt # none | XXX/class_list_DA.txt (depend on users)
anno_file=/net/acadia9a/data/jchoi/data/kinetics/anno/kinetics-7-train_from_running_treadlmill.csv
