...
#SBATCH -J i3d
#SBATCH -o /net/acadia9a/data/jchoi/data/nec_drone/2018/log/Kinetics-7-train-i3d-feat_extraction_20200303_part2of2_from_throwing_ball_part2of2.log
...
anno_file=/net/acadia9a/data/jchoi/data/kinetics/anno/kinetics-7-train_from_running_treadlmill_part2_from_throwing_ball_part2of2.csv
