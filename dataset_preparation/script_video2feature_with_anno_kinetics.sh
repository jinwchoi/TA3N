...
#SBATCH -J i3d-ktr0
#SBATCH -o /net/acadia9a/data/jchoi/data/nec_drone/2018/log/Kinetics-7-val-3d-feat_extraction_20200312_cls0.log
...
start_class=0 # start from 0 end at 12
end_class=0 # -1: process all the categories
