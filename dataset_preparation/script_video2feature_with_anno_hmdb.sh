...
#SBATCH -J i3d
#SBATCH -o /net/acadia9a/data/jchoi/data/nec_drone/2018/log/ucf_hmdb_hmdb-train_val-i3d-feat_extraction_20200312_cls_11of12.log
...
video_in=train
feature_in=/net/acadia9a/data/jchoi/data/ucf_hmdb_full/TA3N/hmdb51/RGB-feature2
input_type=video # video | frames
structure=tsn # tsn | imagenet
num_thread=8
batch_size=50 # need to be larger than 16 for c3d
