...
kinetics_feature_dir = '/net/acadia9a/data/jchoi/data/kinetics/RGB-feature3_i3d'
...
output_anno_path = '/home/mai/jchoi/src/TA3N/dataset_i3d/kinetics/list_kinetics_{}-feature.txt'.format(phase)
...
for i,anno in enumerate(data):
	...
	cur_feat_path = os.path.join(kinetics_feature_dir, phase, cur_cls, cur_id)
	...
	cur_output_anno = 'dataset_i3d/kinetics/RGB-feature_i3d/' + cur_id  + ' {} {}'.format(len(featfile_list), cur_label)
	# cur_output_anno = kinetics_feature_dir + '/' + phase + '/' + cur_cls + '/' + cur_id  + ' {} {}'.format(len(featfile_list), cur_label)	
