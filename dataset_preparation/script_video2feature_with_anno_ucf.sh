...
#SBATCH -J i3d
#SBATCH -o /net/acadia9a/data/jchoi/data/nec_drone/2018/log/ucf_hmdb_ucf-val-i3d-feat_extraction_20200310_seq_cores_9.log
...
video_in=val
feature_in=/net/acadia9a/data/jchoi/data/ucf_hmdb_full/TA3N/UCF/RGB-feature3
