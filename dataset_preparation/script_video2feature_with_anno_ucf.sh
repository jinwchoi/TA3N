...
#SBATCH -J i3d
#SBATCH -o /net/acadia9a/data/jchoi/data/nec_drone/2018/log/ucf_hmdb_ucf-val-train-i3d-feat_extraction_20200312_cls_0to2_of_15.log
...
video_in=val
feature_in=/net/acadia9a/data/jchoi/data/ucf_hmdb_full/TA3N/ucf101/RGB-feature3
...
end_class=2 # -1: process all the categories, inclusive
class_file=/home/mai/jchoi/src/TA3N/data/classInd_hmdb_ucf.txt # none | XXX/class_list_DA.txt (depend on users)
anno_file=/net/acadia9a/data/jchoi/data/ucf_hmdb_full/ucf_anno/anno_ucf_full_train.txt 
