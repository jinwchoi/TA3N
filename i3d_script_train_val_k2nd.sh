...
#SBATCH -J i3d
#SBATCH -o /net/acadia9a/data/jchoi/data/nec_drone/2018/log/kinetics2nec_drone-7-test-i3d_uda_TA3N_20200313_seg3.log
...
path_exp_root=experiments/i3d/action-experiment_k2nd_uda_TA3N/ # depend on users
